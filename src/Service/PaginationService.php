 ...
 *
 * Classe de pagination qui extrait toute notion de calcul et de récupération de nos controllers
 *
 * Elle necessite après instanciation qu'on lui passe l'entité sur laquelle on souhaite travailler
 *
 * Il faut ensuite utiliser la methode display() dans twig pour afficher la pagination
 *
 * @package App\Service
 */
class PaginationService
{
    ...
    /**
     * Le nombre d'enregistrement à récupérer soit le nombre de produit par page
     *
     * @var int
     */
    private $limit = 10;
     ...
     * @return string
     */
    public function getEntityClass(): self
    {
        $this->entityClass;
        return $this;
    }
