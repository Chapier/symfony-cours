    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                'slug',
                TextType::class,
                $this->getConfiguration('Chaine URL','Tapez votre Adresse web (automatique)',
                    ['required' => false]
                )
            )
            ->add(
                'coverImage',
                UrlType::class,
                $this->getConfiguration("URL de l'image principale", "Donnez l'adresse d'une image qui donne vraimet envie")
            )
            ->add(
                'introduction',
                TextType::class,
            ...
            ->add(
                'content',
                TextareaType::class,
                $this->getConfiguration("Description détaillée", "Tapez une description qui vous donne vraiment envie")
            )
            ->add(
                'rooms',
                IntegerType::class,
