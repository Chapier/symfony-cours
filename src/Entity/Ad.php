...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre dexcription doit faire plus de 100 caractères")
     */
    private $content;
    ...
    {
        $sum = array_reduce($this->comments->toArray(), function($total, Comment $comment) {
    ...
    /**
     * Permet d'obtenir un tableau des jours qui ne sont pas disponibes pour cette annonce
    ...
    public function getNotAvailableDays()
    {
        ...
        //Représente un tableau des jours déjà reservé sous forme de Timestamp
        /** @var Booking $booking */
        foreach ($this->bookings as $booking) {
            ...
            //Transforme le tableau résultat en objets DateTIme
